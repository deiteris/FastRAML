...
* **`i-json`** (4 rules, opt-in): for APIs that adopt the
  [RFC 7493](https://www.rfc-editor.org/rfc/rfc7493) I-JSON profile: JSON
  bodies are objects or arrays, integers stay within ±(2⁵³−1), timestamps are
  RFC 3339 with an offset, and binary data is base64url.
