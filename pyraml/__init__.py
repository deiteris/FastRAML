...
_EXPORTS = {
    ...
    'Addresses': ('pyraml.views.walk', 'Addresses'),
    'Edge': ('pyraml.views.graph', 'Edge'),
    'Entity': ('pyraml.nodes', 'Entity'),
    ...
    'Route': ('pyraml.views.graph', 'Route'),
    ...
    'address': ('pyraml.views.walk', 'address'),
    'backend_name': ('pyraml.yamlnode', 'backend_name'),
    'build_graph': ('pyraml.views.graph', 'build_graph'),
    'build_loader': ('pyraml.loaders', 'build_loader'),
    'build_tree': ('pyraml.views.tree', 'build_tree'),
